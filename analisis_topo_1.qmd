...
Crea dos redes con aproximadamente el mismo número de nodos y aristas: una red aleatoria Erdős–Rényi y otra scale-free. Plotearlas.
Ahora, elimina nodos aleatoriamente de cada red y observa cómo cambia la conectividad, ploteando las redes. Reflexiona sobre cuál es más robusta frente a mutaciones o fallos de proteínas en un sistema biológico y por qué.
